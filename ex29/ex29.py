...
print(" 7. Flse and 0!=0 = %s" % str(False and (0!=0)))
print(" 8. Ture or 1==1 = %s" %True or (1 ==1))
...
print(" 15. not(10==1 or 1000=1000) = %s" % (not ((10==1) or (1000==10000))))
...
print("extar 2. 1 and 1 = = %s" % str(1 and 1))
